      ...
      onSubmit={handleSubmit(async (data) => {
        ...
        try {
          ...
          if (result.status === 200) {
            // 성공 케이스
            toast.success("맛집을 성공적으로 등록했습니다.");
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              ...
              >
                <span className="text-red-600">*</span>가게명
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label
                ...
                className="block text-sm font-medium leading-6 text-gray-900"
              >
                <span className="text-red-600">*</span>카테고리
              </label>
              <div className="mt-2">
                <select
            ...
            <div className="sm:col-span-4">
              <label
                ...
                className="block text-sm font-medium leading-6 text-gray-900"
              >
                <span className="text-red-600">*</span>연락처
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="col-span-full">
              <label
                ...
                className="block text-sm font-medium leading-6 text-gray-900"
              >
                <span className="text-red-600">*</span>주소 (다음 주소 검색 API)
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-2 sm:col-start-1">
              <label
                ...
                className="block text-sm font-medium leading-6 text-gray-900"
              >
                <span className="text-red-600">*</span>식품인증구분
              </label>
              <div className="mt-2">
                <select
            ...
            <div className="sm:col-span-2">
              <label
                ...
                className="block text-sm font-medium leading-6 text-gray-900"
              >
                <span className="text-red-600">*</span>업종구분
              </label>
              <div className="mt-2">
                <select
